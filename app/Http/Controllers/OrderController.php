...
class OrderController extends Controller
{
    ...
    public function ViewProductDetails($id){
        ...
        return view('FrontEnd.Customer.ViewProductDetails',['product'=>$product]);
    }
    ...
    public function storeOrderProduct(Request $request){
        ...
        if(!isset($prooductid) || !isset($OwnerId)){
            return redirect('/')->with('message','First select type of vehicle you want to rent for shifting');
        }
