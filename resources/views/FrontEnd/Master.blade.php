...
<div class="services" id="service">
    <div class="container">
        ...
        <p class="sub_para">It’s time to shift easily</p>
        <div class="inner_w3l_agile_grids">
            <div class="col-md-4 agileits_service_grid_btm_left">
                <a href="{{url('ViewProduct/1')}}" >
                <div class="agileits_service_grid_btm_left1" style="cursor: pointer !important">

                    <div class="agileits_service_grid_btm_left2">
                        <h5>Small</h5>
                        <p>Small size truck</p>

                    </div>
                    <img src="{{asset('Extra/images/smallpickup.jpg')}}" alt=" " class="img-responsive">

                </div>
                </a>
            </div>
            <div class="col-md-4 agileits_service_grid_btm_left">
                <a href="{{url('ViewProduct/2')}}" >
                <div class="agileits_service_grid_btm_left1" style="cursor: pointer !important;">

                    <div class="agileits_service_grid_btm_left2" >
                        <h5>Medium</h5>
                        <p>Medium size truck</p>
                    </div>

                    <img src="{{asset('Extra/images/midlorry.jpg')}}" alt=" " class="img-responsive">
                </div>
                </a>
            </div>
            <div class="col-md-4 agileits_service_grid_btm_left">
                <a href="{{url('ViewProduct/3')}}" >
                <div class="agileits_service_grid_btm_left1" style="cursor: pointer !important">

                    <div class="agileits_service_grid_btm_left2" >
                        <h5>Large</h5>

                        <p>Large size truck</p>
                    </div>

                    <img src="{{asset('Extra/images/biglorry.jpg')}}" alt=" " class="img-responsive">
                </div>
                </a>
            </div>
...
<div class="about" id="about">
    <div class="container">
        ...
        <p class="sub_para two">It’s time to Shift easily</p>
        <div class="inner_w3l_agile_grids">
            <div class="col-md-6 about-left-w3layouts">
                <h6 class="sub">WELCOME TO OUR EASYSHIFTER</h6>
...
<div class="map-w3ls">
    ...
    <div class="contact-agile" id="contact">
        ...
        <div class="contact-left">
            ...
            <p><a href="mailto:info@example.com">easyshifter@gmail.com</a></p>
        </div>
