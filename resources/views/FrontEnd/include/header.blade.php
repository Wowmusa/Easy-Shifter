...
<div class="banner-w3ls" id="home">
    ...
    <div class="header-w3l-agile">
        <div class="header_left">
            <ul>
                <li><a href="mailto:info@example.com"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>Easyshifter@gmail.com</a></li>
                <li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>+8801710000000</li>
            </ul>
        </div>
        ...
        <div class="header_right">
            <div class="w3ls-social-icons">
                ...
                <a class="pinterest" href="https://www.google.com/"><i class="fa fa-google-plus"></i></a>
        ...
        <div class="header-nav">
            <nav class="navbar navbar-default">
                <div class="navbar-header">
                    ...
                    <h1><a  href="{{url('/')}}"><span class="logo-c">E</span><i class="fa fa-car" aria-hidden="true"></i>sy shifter</a><p class="sub-cap">Shift to Any where</p></h1>
                </div>
                <!-- navbar-header -->
